...
get_properties <- function(
  ...
  watlas$dtime <- sapply(
    ...
    FUN = function(i) {
      if (i == 1) return(NA)
      return(seconds(watlas[i, "time"] - watlas[i - 1, "time"]))
    }
  )
  # step length
...
get_watlas_for_observation <- function(
  ...
  # create properties
  # TODO raw? now its median smoothed by 3
...
```{r}
write.table(validation_data, 'resources/validation_data_thinned.csv', sep=';')
```
